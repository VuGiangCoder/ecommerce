...
router.get('/change_cart', middleware.verifyToken, middleware.verifyBuyer, userController.changeItemOnCart);
...
router.get('/detail_item/:idItem', middleware.verifyToken, userController.getDetailItem);
router.get('/detail_shop/:idShop', middleware.verifyToken, userController.getDetailShop);
